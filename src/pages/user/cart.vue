...
<template>
  <Default>
      ...
      >
        ...
        <template #footer>
          <div class="tw-flex tw-justify-end">
            <n-button @click="submit" type="primary">Xác nhận</n-button>
          </div>
        </template>
      </n-card>
    </n-modal>
    ...
    <h2 class="tw-text-red-400 tw-text-center ">Quản Lý giỏ hàng</h2>
      ...
      <table class=" tw-justify-center tw-mt-3 tw-mx-40 tw-h-80 tw-w-full tw-bg-slate-400">
        ...
        <tr class="tw-text-center" style="height: 30px" v-for="item in cart">
          ...
          <td>
            ...
            <n-button class="tw-no-underline tw-ml-1 " type="error">Delete</n-button>
          </td>
