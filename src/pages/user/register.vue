        ...
        <div class="tw-w-4/12 tw-h-full tw-flex tw-flex-col tw-justify-center">
          <n-form
            ...
            <n-form-item label="Tên đăng nhập" path="username">
              <n-input v-model:value="formValue.username" placeholder="Nhập tên đăng nhập"/>
            </n-form-item>
            <n-form-item path="email">
              <n-input v-model:value="formValue.email" placeholder="Nhập email"/>
            </n-form-item>
            <n-form-item path="password">
              <n-input type="password" v-model:value="formValue.password" placeholder="Nhập mật khẩu"/>
            </n-form-item>
            <n-form-item path="confirmPassword">
              <n-input type="password" v-model:value="formValue.confirmPassword" placeholder="Xác nhận mật khẩu"/>
            </n-form-item>

            <div class="tw-mt-5">
              <n-button @click="submit" class="tw-w-full " type="primary">Đăng ký</n-button>
            </div>
